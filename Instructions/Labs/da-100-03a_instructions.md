...
26. 「 **クエリの設定**」 ペインで、クエリの名前を **SalespersonRegion** に変更します。
...
66. **Custom Column** ウィンドウの **New Column Name** ボックスで、テキストを **Cost** に置き換えます。
...
103. ステータス バーで、クエリに 3 列と 10 行があることを確認します。  
