...
7. メニューバーで、「**共有**」 をクリックします。

	![画像 82](Linked_image_Files/PowerBI_Lab12A_image4.png)

8. 「**ダッシュボードの共有**」 ウィンドウ (右側) の 「**アクセスの許可**」 ボックスで、受講クラスのパートナーのアカウント名を入力し、候補がリスト表示されたら選択します 。

9. 使用可能なオプションを確認しますが、変更しないでください。

10. 画面の最下部で、「**共有**」 をクリックします。
...
12. 「**売上の監視**」 ダッシュボードが表示されていることを確認します。

	![画像 85](Linked_image_Files/PowerBI_Lab12A_image7.png)

13. ダッシュボードを開くには、「**売上の監視**」 ダッシュボードをクリックします。

14. ダッシュボードの 「**売上累計**」 タイルの値は **$13M** であることを確認してください。
...
16. **ナビゲーション** ウィンドウで、ワークスペースの名前をクリックします。 

	![画像 87](Linked_image_Files/PowerBI_Lab12A_image9.png)

17. 右上の 「**アプリの公開**」 をクリックします。

	![画像 88](Linked_image_Files/PowerBI_Lab12A_image10.png)

18. アプリの公開プロセスでは、次の 3 つのタブで構成する必要があることに注意してください。**構成**、 **ナビゲーション**、および **アクセス許可**。    

	![画像 89](Linked_image_Files/PowerBI_Lab12A_image11.png)

19. 「**説明**」 ボックスに、次のように入力します。  **販売分析と調査**

	![画像 90](Linked_image_Files/PowerBI_Lab12A_image12.png)

20. 「**アプリのロゴ**」 で 「**アップロード**」 をクリックします。

	画像 91](Linked_image_Files/PowerBI_Lab12A_image13.png)

21. 「**開く**」 ウィンドウで、「**D:\DA100\Lab12A\Assets\Icons**」 フォルダーに移動します。   

22. JPG ファイルのいずれかを選択し、「**開く**」 をクリック します。 

23. 「**アプリのテーマ色**」 で任意の色を選択します。

24. 「**ナビゲーション**」 タブを選択します。

	![画像 117](Linked_image_Files/PowerBI_Lab12A_image14.png)

25. 「**ナビゲーション**」 セクションで、公開されるワークスペース コンテンツを確認します。
...
27. 「**特定の個人またはグループ**」 ボックスで、受講クラスのパートナーのアカウント名を入力し、候補がリスト表示されたら選択します。
...
32. ページの中央にある 「**アプリの取得**」 をクリックします。 

	![画像 139](Linked_image_Files/PowerBI_Lab12A_image20.png)

33. 「AppSource」 ウィンドウで、受講クラスのパートナーが公開した**営業分析**アプリの 「**今すぐ取得**」 リンクをクリックします。

	![画像 140](Linked_image_Files/PowerBI_Lab12A_image21.png)

34. アプリが追加されたら、アプリを開き、アプリのタイルをクリックします。

	![画像 141](Linked_image_Files/PowerBI_Lab12A_image22.png)

35. アプリが開いたら、ナビゲーション ウィンドウ (左側) を確認します。

36. ナビゲーション ウィンドウの最初の項目が開いていることに留意してください。

37. 「ナビゲーション」 ウィンドウで、「**売上レポート**」 を展開し、「**概要**」 ページを選択します。

 	![画像 143](Linked_image_Files/PowerBI_Lab12A_image23.png)

38. 「**リージョン**」 スライサーには、Pamela Ansam-Wolfe に割り当てられたリージョンが 2 つしか表示されないことを確認します。

	![画像 145](Linked_image_Files/PowerBI_Lab12A_image24.png)

39. **「マイ パフォーマンス」** ページを選択します。

40. ページには、Pamela Ansam-Wolfe の売上と目標が表示されています。

41. 「**営業調査**」 レポートを開き、各ページのビジュアルと対話します。
